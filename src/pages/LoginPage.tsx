...
import { Activity, Mail, Lock, Eye, EyeOff, Shield, BarChart3, Stethoscope, LogIn, AlertCircle } from "lucide-react";
...
const LoginPage = () => {
  ...
  const quickLogin = (role: "admin" | "manager" | "clinician") => {
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="you@vitaltriage.com"
                required
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-3 mt-4">
              {roleInfo.map(r => (
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-3 rounded-xl border border-border hover:border-secondary/50 hover:shadow-md transition-all group"
                >
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${r.color} group-hover:scale-110 transition-transform`}>
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            Demo credentials: admin@vitaltriage.com / admin123
          </p>
        </motion.div>
      </div>
    </div>
