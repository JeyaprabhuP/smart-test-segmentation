...
export const classificationRules: ClassificationRule[] = [
  ...
  { id: "R007", name: "Hypotension Critical", metric: "Systolic BP", operator: "<", threshold: 90, severity: "critical", active: true, lastModified: "2026-03-17" },
  { id: "R008", name: "Hypothermia Moderate", metric: "Temperature", operator: "<", threshold: 35.5, severity: "moderate", active: true, lastModified: "2026-03-12" },
  { id: "R009", name: "Severe Hypoxia Critical", metric: "O2 Saturation", operator: "<", threshold: 85, severity: "critical", active: true, lastModified: "2026-03-18" },
  { id: "R010", name: "Mild Tachycardia", metric: "Heart Rate", operator: ">", threshold: 100, severity: "moderate", active: true, lastModified: "2026-03-13" },
];
